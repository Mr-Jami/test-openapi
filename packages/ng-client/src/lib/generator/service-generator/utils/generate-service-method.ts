...
export function getResponseTypeFromResponse(response: Response, config?: GeneratorConfig): 'json' | 'blob' | 'arraybuffer' | 'text' {
...
export function getResponseType(response: Response, config?: GeneratorConfig): string {
